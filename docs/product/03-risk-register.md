...
| R-05 | At the fixed 50 participants the player loses their identity or cannot explain the collision that killed them. | High | High | The human keeps its diamond and guard ring; 25+ bot rendering drops redundant decoration while retaining action color, facing, mass-scaled size, and stumble marks. Local Chrome p95 is 16.8 ms with zero backlog. | Test the exact 50-player candidate. Reduce nonessential effects, camera shake, or bot decoration before changing rules or the human marker. | Open |
