...
Version `0.7.0` promotes the 4–32 participant scale boundary with a deterministic spatial broad phase, spatially bounded bot candidates, a 1.5 default DPR cap and 1.0 Mayhem cap, 12/24/32 headless and production-Chrome profiles, and a 20-restart heap check. Replay hashes remain unchanged because candidate reduction preserves collision order and outcomes. The evidence is local and headless; physical-device, cross-browser, round-duration, collapse-cadence, bot-weight, and readability approval remain pending. Items and final presentation are still gated.
