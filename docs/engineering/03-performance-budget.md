...
- Total compressed production JavaScript has a 180 KiB warning budget and CSS has a 20 KiB warning budget before image assets. The functional-feedback 2026-07-22 Vite build reports approximately 159.25 KiB gzip across emitted JavaScript chunks, a 50.18 KiB gzip entry chunk, and 2.25 KiB gzip CSS. Procedural oscillator audio adds no downloaded media. Chunk count alone is not a failure when Vite and PixiJS load the provider-neutral static artifact correctly.
