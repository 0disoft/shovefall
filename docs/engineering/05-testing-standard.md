...
- Browser promotion must still add readable combat and item-telegraph assertions, explicit human-defeat injection, and fatal-invariant recovery. Weak-contact triple-overlap and high-speed crossing fuzz remain required before release.
