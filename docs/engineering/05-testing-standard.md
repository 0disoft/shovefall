...
- Separate configured profiles cover 7,200 headless ticks at the public 60-participant setting and fixed-seed production Chrome frame pacing plus 20 immediate restarts. The main round and strategy scenarios use 60 participants; smaller 8- and 16-participant controlled rotations remain diagnostic fixtures for isolating mass, item-slot, and collapse-speed variables and are not public modes. Profile and balance evidence is not part of the routine smoke suite and does not claim cross-browser, physical-device, risky-pickup item balance, or human-play approval.
