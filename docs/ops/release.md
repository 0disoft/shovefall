...
- Status: `0.138.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.138.0`

Product `0.138.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. Cannonball and grappling-hook anchor positions now also project from raw x/y coordinates instead of allocating temporary vector objects. Visible projectile and hook art, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
