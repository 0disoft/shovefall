...
- Status: `0.135.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.135.0`

Product `0.135.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. The per-step event banner now scans events in reverse without allocating reversed and mapped intermediate arrays before finding the latest message. Visible event banner text, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
