...
- Status: `0.134.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.134.0`

Product `0.134.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. Visual-effect event processing now builds a participant lookup map once per event batch instead of scanning the participant list for each effect's actor position. Visible skill projectiles, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
