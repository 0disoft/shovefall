...
- Current product version: `0.31.0`
...
The current local tree passes merge-blocking checks, the production Chrome smoke suite, the 7,200-tick fixed-50 headless scale profile, and the fixed-50 production Chrome profile. The exact `0.31.0` implementation SHA also passes hosted validation, Pages deployment, and public browser smoke. Active-item bot balance and human playtest remain pending.
