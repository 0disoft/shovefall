...
- Status: `0.146.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.146.0`

Product `0.146.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. Bot position traversal checks now take raw x/y coordinates instead of allocating a position vector per sample, further reducing AI decision allocation. Visible bot movement and navigation, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
