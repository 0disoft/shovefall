...
- Status: `0.133.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.133.0`

Product `0.133.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. The per-frame depth-sort entries for participants, brick walls, and trees are now pushed into a single array in one pass instead of allocating three intermediate map arrays and spreading them into a fourth before sorting. Visible draw order, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
