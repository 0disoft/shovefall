...
- Status: `0.130.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.130.0`

Product `0.130.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. The human participant is now looked up once per draw and reused for both camera spectator detection and proximity feedback instead of scanning the participant list a second time. Visible camera mode and action feedback, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
