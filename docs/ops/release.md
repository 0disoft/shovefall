...
- Status: `0.147.0` complete-island cannon-collapse candidate; hosted proof pending
- Primary owner: Repository owner
- Current product version: `0.147.0`

Product `0.147.0`, simulation `78.0.0`, and content `48.0.0` keep simulation `78.0.0`,
content `48.0.0`, replay v8, and reports v11. Bot crowd counting now counts nearby controllable participants in a single pass with inline distance instead of allocating a filtered array and intermediate vector objects per decision. Visible bot steering, combat results, replay hash, and balance are unchanged. Hosted proof, complete-collapse pacing, and human readability remain pending.
