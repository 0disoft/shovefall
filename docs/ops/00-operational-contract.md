...
2. `게임 시작` uses the last saved settings, reveals the arena, enters a visible countdown, and then accepts keyboard, right-click destination, touch-joystick, and standard-gamepad input.
