...
- Status: Playable 8/16/24/32 participant rounds with deterministic items, Coal-Twilight presentation, and GitHub Pages deployment configured
- Scope: frontend
