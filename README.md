...
The toolchain, replay format v2, fixed-tick physics, swept-circle and static-wall contact, bounded browser scheduler, Coal-Twilight PixiJS renderer, fixed Hard utility bots, selectable collapse speed, automatic growth planning, cannon collapse, protected-core rock pressure, one 50-participant browser mode, nine starting items, eight accepted generated-image assets, optional procedural audio, deterministic balance auditing, and source-owned GitHub Actions Pages workflow are implemented locally for product `0.38.0`, simulation `19.0.0`, and content `13.0.0`; reports use v5. Production HTML contains no developer telemetry or tuning-lab markup. The production artifact has thirteen Chrome paths. Active-item human balance, uncontended browser performance, broader physical-device and cross-browser coverage, and external playtest remain pending or separately gated.
