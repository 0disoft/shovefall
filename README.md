...
Product `0.98.0`, simulation `62.0.0`, content `38.0.0`, replay v8, and local reports v10 own these current local rules. Hosted `0.37.0` remains the last deployed proof; the `0.98.0` candidate, human playtest, uncontended browser performance, and cross-browser checks remain pending.
