...
| `test` | Vitest 4 | Runs loadout normalization, starting effects, deterministic simulation, replay parsing, spatial-hash equivalence, slower mass-sensitive movement, compact hand-reach shove timing, batch impulse, dodge, support, credited elimination, bounded stat spending, item effects, collapse, round sealing, report v3, keyboard/pointer/gamepad input state, bot determinism, delayed perception, tile safety, and targeting coverage. |
