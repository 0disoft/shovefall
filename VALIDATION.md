...
Web-app validation covers the playable DOM/PixiJS gray-box, deterministic utility bots, seeded collapse, three bounded items, item settings, round result, fresh-world restart, spatial broad phase, and bounded local scale profiles without claiming physical-device, cross-browser, or external playtest approval.
