...
Web-app validation covers the playable DOM/PixiJS gray-box, deterministic connected island coastlines and multiple lakes, a connected 20% collapse floor, one public 50-participant Hard-AI mode, a 50–100 starting-weight slider, selectable Slow/Normal/Fast seeded collapse, three bounded shoreline-weighted map items, the nine-entry catalog, five currently offered loadout items, two-charge Wind Blast and four-charge Brick Bag through keyboard/gamepad/DOM slot bridges, static-wall attack and body collision, item settings, pre-round countdown, round result, fresh-world restart, optional procedural audio, reduced-motion presentation, renderer loss recovery, spatial broad phase, local production-artifact smoke, deterministic mass, synthetic item-grant and collapse-pacing screens, and 50-participant local profiles without claiming hosted deployment, physical-device, cross-browser, audio-device, active-item bot balance, risky-pickup item balance, human balance, or external playtest approval.
