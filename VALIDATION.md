...
| `test` | Vitest 4 | Runs loadout normalization, starting effects, deterministic connected island generation, exact eight-lake public topology and lake budget, supported 50-participant spawn placement, the widened public arena budget, protected 20% collapse cores across every internal tier, topology-independent 3:2:1 item spawn-band selection, replay v2 parsing and starting setup, spatial-hash equivalence and launch containment, numeric weight mapping, slower mass-sensitive movement, compact hand-reach shove timing, batch impulse, Wind Blast charges and first-hit selection, dodge and action priority, contact transfer, offensive-credit arbitration, Brick Bag placement and blocking, Boat support, Bomb charge/placement/actor-order/fuse/flood persistence/dodge/self-hit, Soap charge/placement/actor-order/occupancy/trigger/dodge/self-credit/flood removal, Grappling Hook range/minimum/anchor ordering/mass response/charge fallback/pull expiry/support/credit/Bomb-Wind override, bounded stat spending, item effects, collapse, round sealing, report v4, keyboard/pointer/gamepad input state, version-history completeness, 58-degree projection math and public-world camera following, Bomb, Soap, and Grappling Hook rendering/audio, bot determinism, shoreline safety, delayed perception, tile safety, and targeting coverage. |
...
Web-app validation covers the playable DOM/PixiJS gray-box, a 48×40 deterministic connected public island with exactly eight separated 6–10-tile lakes and a connected 20% collapse floor, one public 50-participant Hard-AI mode, a 50–100 starting-weight slider, selectable Slow/Normal/Fast seeded collapse, three map items chosen through topology-independent edge/near-edge/interior bands, the nine-entry catalog and nine offered loadout items, two-charge Wind Blast, four-charge Brick Bag, one-charge five-second Boat, two-charge five-second Bomb, three-charge Soap, and two-charge static-anchor Grappling Hook through keyboard/gamepad/DOM slot bridges, static-wall attack and body collision, bounded water support, deterministic radial blast, one-use slip-patch state, and mass-sensitive non-teleport Hook pull, item settings, pre-round countdown, round result, fresh-world restart, optional procedural audio, reduced-motion presentation, renderer loss recovery, spatial broad phase, local production-artifact smoke, deterministic mass, synthetic item-grant and collapse-pacing screens, and 50-participant local profiles without claiming hosted deployment, physical-device, cross-browser, audio-device, active-item bot balance, risky-pickup item balance, human balance, or external playtest approval.
